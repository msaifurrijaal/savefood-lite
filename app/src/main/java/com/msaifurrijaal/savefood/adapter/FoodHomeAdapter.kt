...
class FoodHomeAdapter @Inject constructor(): RecyclerView.Adapter<FoodHomeAdapter.ViewHolder>() {
    ...
    class ViewHolder(var binding: LayoutItemFoodHomeBinding): RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutItemFoodHomeBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
